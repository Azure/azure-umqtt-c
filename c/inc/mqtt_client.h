...
typedef int(*ON_MQTT_MESSAGE_RECV_CALLBACK)(MQTT_MESSAGE_HANDLE msgHandle, void* context);
...
extern int mqttclient_subscribe(MQTTCLIENT_HANDLE handle, BYTE packetId, const SUBSCRIBE_PAYLOAD* payloadList, size_t payloadCount);
extern int mqttclient_unsubscribe(MQTTCLIENT_HANDLE handle, BYTE packetId, const char** unsubscribeTopic, size_t payloadCount);
